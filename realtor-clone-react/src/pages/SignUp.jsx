      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input placeholder='Full name'
           ...
           <p className='-mb-60'>Have a account?
            <Link className='text-red-600 hover:red-700 
            transition duration-200 ease-in-out ml-1' to="/sign-in">Register</Link>
            </p>
            <p>
            <Link className='text-blue-600 hover:blue-700 transition duration-200 ease-in-out ml-1'
             to="/forgot-pass">Forgot password?</Link>
            </p>
           </div>
           <button className='w-full bg-blue-600 text-white px-7 py-3 
          text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type='submit'>Sign up</button>
